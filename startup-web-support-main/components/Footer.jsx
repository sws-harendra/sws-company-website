      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm">
              Transform your business with our expert web and mobile app
              development. We craft custom solutions and use cutting-edge tech
              to boost your brand’s online presence.{" "}
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span>
                  3rd Floor, Parvati Tower, Phulwari Rd, Jagdeo Path, Patna,
                  Bihar 800014
                </span>
              </li>
        ...
        <div className="mt-12 pt-8 border-t border-slate-700 flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4">
            <Link
              href="https://www.facebook.com/startupwebsupport/"
            ...
            <Link
              href="https://www.linkedin.com/company/startupwebsupport/"
              className="text-slate-400 hover:text-white transition-colors"
            >
              <Linkedin />
            </Link>
            <Link
              href="https://www.instagram.com/startup_web_support/"
              className="text-slate-400 hover:text-white transition-colors"
            >
              <Instagram />
            </Link>
