      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              <IoLeafOutline className="text-3xl text-cyan-300" />{" "}
              {/* Adjusted icon color */}
            ...
            <motion.p
              ...
              variants={textChildVariants}
            >
              A Section 8 Company is established for promoting non-profit
              objectives such as commerce, art, science, sports, education,
              research, social welfare, religion, charity, or environmental
              protection. These companies apply their profits, if any, towards
              promoting their objects and are prohibited from paying any
            ...
            <motion.p
              ...
              variants={textChildVariants}
            >
              Registering as a Section 8 Company provides credibility and offers
              tax exemptions under Section 80G. We assist with the entire
              registration process, including obtaining the necessary licenses
              and approvals from the Central Government (MCA).
            </motion.p>
