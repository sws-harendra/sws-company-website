        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              variants={textChildVariants}
            >
              A Private Limited Company is a popular choice for startups and
              growing businesses due to its separate legal identity, limited
              liability for shareholders, and ability to raise funds easily. It
              offers credibility and is preferred by investors.
            </motion.p>
            <motion.p
              className="text-gray-700 text-lg leading-relaxed"
              variants={textChildVariants}
            >
              Our services cover the entire registration process with the
              Ministry of Corporate Affairs (MCA), including obtaining Director
              Identification Numbers (DIN), Digital Signature Certificates
              (DSC), name approval (RUN), and filing incorporation documents
              like MoA and AoA.
            </motion.p>
