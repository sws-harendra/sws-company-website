...
const applicationSteps = [
  {
    ...
    description:
      "Update your resume to highlight relevant skills and experience. Write a cover letter explaining your interest and goals.",
  },
  {
    icon: IoCloudUploadOutline,
    title: "Submit Your Application",
    description:
      "Visit the careers page on the Startup Web Support website and complete the online application form. Attach your resume, cover letter, and any relevant work samples.",
  },
  {
    icon: IoChatbubblesOutline,
    title: "Interview Process",
    description:
      "If shortlisted, you will be invited for an interview. This may include technical assessments, coding challenges, and behavioral questions.",
  },
  {
    icon: IoCheckmarkCircleOutline,
    title: "Acceptance and Onboarding",
    description:
      "If selected, you will receive an offer letter with details about the program, start date, and onboarding process to get you started smoothly.",
  },
];
      ...
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            If you are passionate about technology and eager to gain hands-on
            experience in a dynamic environment, we encourage you to apply for
            the 6-month IT internship at Startup Web Support. Here’s how you can
            apply:
          </motion.p>
        </motion.div>
        {/* Steps Grid */}
        ...
        >
          <motion.p
            ...
            variants={itemVariants}
          >
            The 6-month IT internship at Startup Web Support is an excellent
            opportunity for aspiring tech professionals. With a focus on
            hands-on learning, mentorship, and professional development, our
            program is designed to help you achieve your goals and make a
            meaningful impact. Apply today!
          </motion.p>
