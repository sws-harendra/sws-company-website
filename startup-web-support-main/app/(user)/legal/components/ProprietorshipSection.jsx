        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              variants={textChildVariants}
            >
              A Sole Proprietorship is the simplest business structure where one
              individual owns and runs the business. It's easy to set up and
              requires minimal compliance, making it ideal for freelancers and
            ...
            <motion.p
              ...
              variants={textChildVariants}
            >
              We assist in obtaining necessary registrations like GST (if
              applicable) and MSME/Udyam registration to establish your
              proprietorship firm legally and enable smooth operations.
            </motion.p>
