        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              variants={textChildVariants}
            >
              A Limited Liability Partnership (LLP) combines the flexibility of
              a partnership with the benefits of limited liability like a
              company. Partners are not personally liable for the business's
              debts or negligence of other partners, making it a safer
              structure.
            </motion.p>
            <motion.p
              ...
              variants={textChildVariants}
            >
              Registering an LLP involves obtaining Designated Partner
              Identification Numbers (DPINs), Digital Signatures (DSCs), name
              approval, and filing the incorporation document (FiLLiP) with the
              MCA. We handle the entire process efficiently for you.
            </motion.p>
