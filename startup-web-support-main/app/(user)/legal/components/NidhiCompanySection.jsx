        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              ...
              recognized under Section 406 of the Companies Act, 2013. Its core
              business is borrowing and lending money only among its members
              (shareholders), promoting the habit of thrift and saving.
            </motion.p>
            <motion.p
              className="text-gray-700 text-lg leading-relaxed"
              variants={textChildVariants}
            >
              Registering a Nidhi Company involves incorporation as a public
              limited company with specific objectives and compliance
              requirements set by the MCA. We assist with the complete
              registration process, ensuring adherence to Nidhi Rules, 2014.
            </motion.p>
            <motion.div className="mt-8" variants={textChildVariants}>
              <Link
                href="/contact-us"
                className="inline-flex items-center bg-sky-700 hover:bg-sky-800
                text-white font-semibold py-3 px-6 rounded-lg shadow
                transition-colors"
              >
                {" "}
                Register Now
