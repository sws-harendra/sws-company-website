      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              <IoPersonOutline className="text-3xl text-cyan-300" />{" "}
              {/* Adjusted icon color */}
            ...
            <motion.p
              ...
              variants={textChildVariants}
            >
              An One Person Company (OPC) allows a single entrepreneur to
              operate a corporate entity with limited liability protection,
              which was previously only available to private limited companies.
              It combines the benefits of a sole proprietorship (single owner)
            ...
            <motion.p
              ...
              variants={textChildVariants}
            >
              Ideal for solo entrepreneurs looking for credibility and limited
              liability, OPC registration involves similar steps to a private
              limited company but with simpler compliance. We provide complete
              support for registering your OPC with the MCA.
            </motion.p>
